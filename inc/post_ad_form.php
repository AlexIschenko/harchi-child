...
function ad_post_short_base_func($atts, $content = '')
{
	...
	$ad_type_html =	
	'
		<select class="category form-control" id="type" name="buy_sell" data-parsley-required="true" data-parsley-error-message="'. __( 'This field is required.', 'adforest' ) .'">
			<option value="">'. __('Select Option', 'adforest' ) . '</option>
	';
	$types = adforest_get_cats('ad_type' , 0 );
	
	// if ad type already set
	if ( $ad_type ) { 
	...
	// if ad type empty then set sell as default
	} else { 
...
// EDITED TO SET FIXED PRICE AS DEFAULT
		if ( $ad_price_type == '' ) 
		{
			$sb_price_types_html	=	'';
			foreach( $sb_price_types as $p_type )
	  ...
	  $priceTypeHTML =  '<div class="row"><!-- Price  -->
	   ...
	   if( isset( $adforest_theme['allow_price_type'] )  )
	   {
		   if( $adforest_theme['allow_price_type'] )
		   {
				  ...
				  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
					 <label class="control-label">'. __('Price Type', 'adforest' )  . ' <span class="required">*</span></label>
					 <select class="form-control" name="ad_price_type" id="ad_price_type" data-parsley-required="true" data-parsley-error-message="'. __( 'This field is required.', 'adforest' ) .'">
	   ...
	   $priceStaticHTML .= $priceTypeHTML;
		...
		<div class="row">
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			 ...
			 <div class="btn btn-secondary upload_photos_button"><!--:ru-->Добавить изображения<!--:ua-->Додати зображення<!--:--></div>
		  </div>
		  <script type="text/javascript">
			jQuery(document).ready(function($) {
				$(".upload_photos_button").click(function() {
		...
		$someStaticHTML = '
			...
			<div class="row" >
				...
				<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
					<div class="form-group">
						<label class="control-label">'. __('Type of Ad', 'adforest' ) . ' <span class="required">*</span></label>
						'.$ad_type_html.'
					</div>
				</div>
	...
	if( isset( $adforest_theme['sb_custom_location'] ) && $adforest_theme['sb_custom_location'] )
	{
		...
		$custom_locations_html	=	'<div class="row">
		   ...
		   <div class="row" id="ad_country_sub_div">
			  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
			  <label class="control-label">'. $loc_lvl_2 . ' <span class="required">*</span></label>
				<select class="category form-control" id="ad_country_states" name="ad_country_states" data-parsley-required="true" data-parsley-error-message="'. esc_html__( 'This field is required.', 'adforest' ) .'">
					'.$country_states.'
				</select>
			  </div>
			</div>
							...
							<div>
								...
								<div id="step-0" class="">
									...
									<div class="row">
										...
										<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
											<label class="control-label">'.__( 'Title', 'adforest' ) .' <span class="required">*</span> <small>'. __('[:ru]Максимум 120 символов[:ua]Максимум 120 символів[:]') . '</small></label>
											<input class="form-control" placeholder="'.__( 'Enter ad title here', 'adforest' ) .'" type="text" maxlength="120" name="ad_title" id="ad_title" data-parsley-required="true" data-parsley-error-message="'. __( 'This field is required.', 'adforest' ) .'" value="'.$title.'" autocomplete="off">
									...
									<div class="row" id="ad_cat_sub_div">
										<!-- Category  -->
										<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
											<select class="category form-control" id="ad_cat_sub" name="ad_cat_sub" data-parsley-required="false" data-parsley-error-message="'. __( 'This field is required.', 'adforest' ) .'">
												'.$sub_cats_html.'
											</select>
										</div>
									</div>
									...
									<div class="row" id="ad_cat_sub_sub_div" >
										<!-- Category  -->
										<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
											<select class="category form-control" id="ad_cat_sub_sub" name="ad_cat_sub_sub" data-parsley-required="false" data-parsley-error-message="'. __( 'This field is required.', 'adforest' ) .'">
												'.$sub_sub_cats_html.'
											</select>
										</div>
									</div>
									...
									<div class="row" id="ad_cat_sub_sub_sub_div">
										<!-- Category  -->
										<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
											<select class="category form-control" id="ad_cat_sub_sub_sub" name="ad_cat_sub_sub_sub" data-parsley-required="false" data-parsley-error-message="'. __( 'This field is required.', 'adforest' ) .'">
												'.$sub_sub_sub_cats_html.'
											</select>
										</div>
									</div>
								...
								<div id="step-2" class="">
									...
									<div class="row">
										...
										<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
											...
											<input class="form-control" value="'.$ad_location.'" type="text" name="sb_user_address" id="sb_user_address" placeholder="'.__('Enter a location','adforest').'" onkeydown="return (event.keyCode!=13);">
										</div>
